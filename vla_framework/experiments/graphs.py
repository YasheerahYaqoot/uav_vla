...
def plot_trajectory_length_comparison(vlm_lengths, mp_lengths, deviations, images, file_path):
...
def plot_rmse_boxplot(knn_errors, dtw_rmse, interp_rmse, file_path):
    data_dict = {
