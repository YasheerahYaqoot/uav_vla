...
file_path = "rmse.txt"
images, knn_errors, dtw_rmse, interp_rmse = read_rmse_data(file_path)
assert len(images) == len(knn_errors) == len(dtw_rmse) == len(interp_rmse), "Data mismatch!"
...
print(" ")
print('----------Error Comparison Table (Error in meters)------------')
aggregates = {
